...
get_species_files <- function(species_name, gene_type) {
  species_path <-
    if (gene_type == "reference") {
      paste0("/home/derezanin/temp_storage/bears/", species_name, "/tblastn_hits/e2_hits_80aa")
    } else if (gene_type == "mhc") {
      paste0("/home/derezanin/temp_storage/bears/", species_name, "/tblastn_hits/e2_MHC_hits_80aa")
    } else {
...
### Estimating copy number of MHC genes in each species
