...
species = c("brown_bear","giant_panda","polar_bear","sun_bear")

get_species_files <- function(species) {
  species_path = paste0("/home/derezanin/temp_storage/bears/", species ,"/tblastn_hits/e2_ref_exon_hits_no_dup")
